...
<form method="post" class="space-y-6">
    ...
    <div class="admin-card p-6 space-y-5">
        ...
        <div class="grid md:grid-cols-3 gap-4">
            <label><span class="admin-label">Provedor</span><select name="payment_provider" class="admin-input"><option value="manual" <?= adminIntegrationValue('payment_provider','manual')==='manual'?'selected':'' ?>>Manual / sandbox</option><option value="mercadopago" <?= adminIntegrationValue('payment_provider')==='mercadopago'?'selected':'' ?>>Mercado Pago</option><option value="stripe" <?= adminIntegrationValue('payment_provider')==='stripe'?'selected':'' ?>>Stripe</option><option value="pagarme" <?= adminIntegrationValue('payment_provider')==='pagarme'?'selected':'' ?>>Pagar.me</option><option value="blackcat" <?= adminIntegrationValue('payment_provider')==='blackcat'?'selected':'' ?>>BlackCat PIX</option></select></label>
            <label><span class="admin-label">Chave pública</span><input name="payment_public_key" value="<?= e(adminIntegrationValue('payment_public_key')) ?>" class="admin-input" autocomplete="off"></label>
            <label><span class="admin-label">Chave secreta</span><input type="password" name="payment_secret_key" class="admin-input" placeholder="<?= e(adminSecretHint('payment_secret_key')) ?>" autocomplete="new-password"></label>
            <label class="md:col-span-2"><span class="admin-label">Segredo do webhook</span><input type="password" name="payment_webhook_secret" class="admin-input" placeholder="<?= e(adminSecretHint('payment_webhook_secret')) ?>" autocomplete="new-password"></label>
    ...
    <div class="admin-card p-6 space-y-5">
        ...
        <div class="grid md:grid-cols-3 gap-4">
            ...
            <label class="md:col-span-3"><span class="admin-label">API key</span><input type="password" name="email_api_key" class="admin-input" placeholder="<?= e(adminSecretHint('email_api_key')) ?>" autocomplete="new-password"></label>
    ...
    <div class="admin-card p-6 space-y-5">
        ...
        <div class="grid md:grid-cols-3 gap-4">
            <label><span class="admin-label">GA4 Measurement ID</span><input name="analytics_ga4_id" value="<?= e(adminIntegrationValue('analytics_ga4_id', adminIntegrationValue('ga_id'))) ?>" class="admin-input" placeholder="G-XXXXXXXXXX"></label>
    ...
    <div class="admin-card p-6 space-y-5">
        ...
        <div class="grid md:grid-cols-3 gap-4">
            <label class="md:col-span-2"><span class="admin-label">URL do webhook interno</span><input name="ops_webhook_url" value="<?= e(adminIntegrationValue('ops_webhook_url')) ?>" class="admin-input" placeholder="Slack, Discord, Make, n8n ou endpoint próprio"></label>
            ...
            <label><span class="admin-label">WhatsApp phone ID</span><input name="whatsapp_phone_id" value="<?= e(adminIntegrationValue('whatsapp_phone_id')) ?>" class="admin-input"></label>
    ...
    <div class="admin-card p-6 space-y-5">
        ...
        <div class="grid md:grid-cols-3 gap-4">
            <label class="md:col-span-3"><span class="admin-label">Diretório de backup</span><input name="backup_path" value="<?= e(adminIntegrationValue('backup_path', ROOT_DIR . '/storage/backups')) ?>" class="admin-input"></label>
