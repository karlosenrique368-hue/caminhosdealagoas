...
$adminHelps = [
    ...
    '/admin/macaiok' => ['Macaiok Vivências', 'Acompanhe escolas, responsáveis, pagamentos e links das vivências pedagógicas.', ['Cada escola pode ter acesso próprio ao portal Macaiok.', 'Os pagamentos dos pais ficam ligados à escola para conferência operacional.']],
    ...
    <aside class="admin-sidebar fixed lg:sticky lg:top-0 inset-y-0 lg:inset-y-auto left-0 z-40 flex-shrink-0 transition-transform lg:h-screen lg:self-start"
        ...
        <nav class="p-4 space-y-1" style="max-height:calc(100vh - 180px)">
            ...
            $menu = [
                ...
                ['path' => '/admin/macaiok', 'icon' => 'graduation-cap', 'label' => 'Macaiok'],
                ['heading' => 'Sistema'],
