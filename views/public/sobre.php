...
?>
<section class="pt-36 pb-16 relative overflow-hidden" style="background:linear-gradient(135deg,var(--horizonte) 0%,var(--maresia) 100%)">
    <div class="relative max-w-5xl mx-auto px-6 text-center text-white">
        <span class="text-xs font-bold tracking-[0.3em] uppercase" style="color:var(--areia-light)">Nossa história</span>
        <h1 class="font-display text-5xl md:text-6xl font-bold mt-3 mb-4">Feito por quem é daqui</h1>
        <p class="text-white/85 max-w-2xl mx-auto">Mais de 10 anos transformando viagens em vivências autênticas em Alagoas.</p>
    </div>
</section>
