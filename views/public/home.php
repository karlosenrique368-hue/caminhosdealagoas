...
<!-- ================================================
     TRUST STRIP
================================================ -->
<section class="py-8 relative" style="background:var(--bg-surface);border-bottom:1px solid var(--border-default)">
...
<!-- ================================================
     DESTAQUES — Roteiros
================================================ -->
<div class="section-divider-seal" style="--seal-img: url('<?= asset('brand/selo-terracota.png') ?>'); margin:-32px auto 0" aria-hidden="true"></div>
                        ...
                        <div class="flex items-end justify-between pt-3 border-t" style="border-color:var(--border-default)">
                            <div>
                                <?php if ($r['price_pix'] && $r['price_pix'] < $r['price']): ?>
                                    ...
                                    <div class="font-brand text-xl" style="color:var(--terracota)"><?= formatBRL($r['price_pix']) ?></div>
                                <?php else: ?>
                                    <div class="text-[10px] uppercase tracking-wider font-semibold" style="color:var(--text-muted)">A partir de</div>
                                    <div class="font-brand text-xl" style="color:var(--terracota)"><?= formatBRL($r['price']) ?></div>
                                <?php endif; ?>
                            </div>
...
<!-- ================================================
     PACOTES EM DESTAQUE
================================================ -->
<div class="section-divider-seal" style="--seal-img: url('<?= asset('brand/selo-azul.png') ?>'); margin:-32px auto 0" aria-hidden="true"></div>
